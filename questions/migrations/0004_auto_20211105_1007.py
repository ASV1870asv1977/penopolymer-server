...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('questions', '0003_alter_questionspage_question_answer'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='questions.questionspage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
